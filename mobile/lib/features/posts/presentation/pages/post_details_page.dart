...
class _PostDetailsPageState extends State<PostDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<PostDetailsBloc>(
      create: (_) => sl<PostDetailsBloc>()
        ..add(
          LoadComments(postId:widget.post.id,post: widget.post),
        ),
  ...
  List<CommentEntity>? _getCommentsFromState(
  ...
  Widget _buildAuthorHeader(
    ...
    final hasPicture =
        post.author.picture != null &&
            post.author.picture!.trim().isNotEmpty;
    ...
    return Row(
      children: [
        CircleAvatar(
          ...
          backgroundImage:
          hasPicture ? NetworkImage(post.author.picture!) : null,
          child: !hasPicture
              ? Icon(
    ...
    return Column(
      children: comments.map((comment) {
        return _CommentTile(
          ...
          onLike: () {
            context.read<PostDetailsBloc>().add(
              LikeCommentRequested(comment.id),
            );
          },
          onUnlike: () {
            context.read<PostDetailsBloc>().add(
              UnlikeCommentRequested(comment.id),
            );
          },
        );
      }).toList(),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'الرد على $_replyingToAuthorName',
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                            fontSize: 12,
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText:
                        isReplying ? 'اكتب ردك...' : 'اكتب تعليقاً...',
                        filled: true,
                        fillColor:
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: colors.surfaceContainerHighest.withOpacity(.5),
            borderRadius: BorderRadius.circular(22),
            border: Border.all(
      ...
      child: Row(
        ...
        children: [
          CircleAvatar(
            ...
            backgroundColor: AppColors.primaryLight,
            backgroundImage:
            hasPicture ? NetworkImage(comment.author.picture!) : null,
            child: !hasPicture
                ? Icon(
              Icons.person_rounded,
              size: 17,
